...
! function (a, b) {
	...
	var id = "January_فوریه_March_April_May_June_July_August_September_October_November_December".split("_"),
	...
	var Ad = "یکشنبه_دوشنبه_سه شنبه_چهارشنبه_پنجشنبه_جمعه_شنبه".split("_"),
		Bd = "یک_دو_سه_چهار_پنج_جمعه_شنبه".split("_"),
