! function (t, e) {
	...
	function vd(t) {
		t.each(function (e) {
			...
			if (c) i = "center", a = [[n = (h[0][0] + h[1][0] + h[2][0] + h[3][0]) / 4, o = (h[0][1] + h[1][1] + h[2][1] + h[3][1]) / 4], [n, o]];
			else {
	...
	function Rv(t, e, i) {
		...
		for (var a = {
				width: e.getWidth(),
				height: e.getHeight()
			}, r = "horizontal" === n.orient ? 1 : 0, s = [["left", "right", "width"], ["top", "bottom", "height"]], l = s[r], u = [0, null, 10], h = {}, c = 0; c < 3; c++) h[s[1 - r][c]] = u[c], h[l[c]] = 2 === c ? i[0] : n[l[c]];
	...
	var NS = {
			...
			textStyle: {
				fontFamily: PS.match(/^Win/) ? "IRANSansDN" : "sans-serif",
				fontSize: 12,
				fontStyle: "normal",
				fontWeight: "normal"
			},
	...
	var SM = {
		...
		AM = {
			toolbox: {
				...
				magicType: {
					title: {
						line: "تغییر به نمودار خط",
						bar: "تغییر به نمودار میله ای",
						stack: "Stack",
						tiled: "عنوان"
					}
				},
	...
	var Qk = d,
		...
		eP = ms({
			...
			doInit: function (t) {
				var e = this.option;
				Ax.canvasSupported || (e.realtime = !1), this._setDefaultThrottle(t), xv(this, t), Qk([["start", "startValue"], ["end", "endValue"]], function (t, i) {
				...
				d(t.pieces, function (t, i) {
					...
					if (null != t.label && (n.text = t.label), t.hasOwnProperty("value")) {
						...
						for (var a = n.interval = [], r = n.close = [0, 0], s = [1, 0, 1], l = [-1 / 0, 1 / 0], u = [], h = 0; h < 2; h++) {
							for (var c = [["gte", "gt", "min"], ["lte", "lt", "max"]][h], d = 0; d < 3 && null == a[h]; d++) a[h] = t[c[d]], r[h] = s[d], u[h] = 2 === d;
							null == a[h] && (a[h] = l[h])
						}
