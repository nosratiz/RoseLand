...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200529144813_UpdateStats")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 29, 19, 18, 13, 250, DateTimeKind.Local).AddTicks(4484));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 19, 18, 13, 257, DateTimeKind.Local).AddTicks(5213));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.DailyStatistic", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 19, 18, 13, 268, DateTimeKind.Local).AddTicks(1654));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Statistic", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("4a372815-7724-44d5-b3f5-c8d5dc539e61"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 19, 18, 13, 292, DateTimeKind.Local).AddTicks(3786));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 19, 18, 13, 292, DateTimeKind.Local).AddTicks(3524));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 19, 18, 13, 294, DateTimeKind.Local).AddTicks(3410));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Shop.OrderItem", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Domain.Entities.Shop.ProductVariant", "Product")
                        .WithMany("OrderItems")
