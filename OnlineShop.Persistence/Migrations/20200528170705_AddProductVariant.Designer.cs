...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200528170705_AddProductVariant")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 28, 21, 37, 5, 219, DateTimeKind.Local).AddTicks(3194));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 21, 37, 5, 225, DateTimeKind.Local).AddTicks(3140));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 21, 37, 5, 233, DateTimeKind.Local).AddTicks(3924));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("3a34473c-8373-44f1-8515-c35708f60e85"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 21, 37, 5, 251, DateTimeKind.Local).AddTicks(3746));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 21, 37, 5, 251, DateTimeKind.Local).AddTicks(3479));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 21, 37, 5, 253, DateTimeKind.Local).AddTicks(929));
