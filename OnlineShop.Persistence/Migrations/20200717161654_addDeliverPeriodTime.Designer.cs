...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200717161654_addDeliverPeriodTime")]
    partial class addDeliverPeriodTime
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 7, 17, 20, 46, 54, 399, DateTimeKind.Local).AddTicks(356));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 17, 20, 46, 54, 404, DateTimeKind.Local).AddTicks(927));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 17, 20, 46, 54, 411, DateTimeKind.Local).AddTicks(3148));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Shop.Order", b =>
                {
                    ...
                    b.Property<int>("DeliverPeriodTime")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagement.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagement.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("8c1a8b7f-cb50-4919-b0ed-c1ca78e90c19"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 19, 20, 46, 54, 430, DateTimeKind.Local).AddTicks(4605));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 17, 20, 46, 54, 430, DateTimeKind.Local).AddTicks(4344));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagement.UserFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 17, 20, 46, 54, 433, DateTimeKind.Local).AddTicks(5568));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagement.UserToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagment.UserDiscountCode", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("UserDiscountCodeId")
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:IdentityIncrement", 1)
                        .HasAnnotation("SqlServer:IdentitySeed", 1)
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.statistic.ShopStatistic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("ShopStatisticId")
                        .HasColumnType("bigint")
                        .HasAnnotation("SqlServer:IdentityIncrement", 1)
                        .HasAnnotation("SqlServer:IdentitySeed", 1)
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.HasOne("OnlineShop.Domain.Entities.UserManagement.User", "User")
                        .WithMany("Blogs")
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagement.User", b =>
                {
                    b.HasOne("OnlineShop.Domain.Entities.UserManagement.Role", "Role")
                        .WithMany("Users")
