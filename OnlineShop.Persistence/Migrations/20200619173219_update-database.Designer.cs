...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200619173219_update-database")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 6, 19, 22, 2, 18, 899, DateTimeKind.Local).AddTicks(9290));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 19, 22, 2, 18, 905, DateTimeKind.Local).AddTicks(4468));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 19, 22, 2, 18, 912, DateTimeKind.Local).AddTicks(8795));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagment.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("0f1ece16-ba9b-4beb-92ea-ec97fcc5745a"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 21, 22, 2, 18, 931, DateTimeKind.Local).AddTicks(2119));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 19, 22, 2, 18, 931, DateTimeKind.Local).AddTicks(1841));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagment.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 19, 22, 2, 18, 932, DateTimeKind.Local).AddTicks(7490));
