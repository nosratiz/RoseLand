...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200610173824_UpdateProductCategory")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 6, 10, 22, 8, 24, 341, DateTimeKind.Local).AddTicks(5195));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 10, 22, 8, 24, 346, DateTimeKind.Local).AddTicks(8313));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 10, 22, 8, 24, 354, DateTimeKind.Local).AddTicks(5132));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("cdd9e6f6-f804-4c46-97b9-4ea4f8b41620"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 12, 22, 8, 24, 371, DateTimeKind.Local).AddTicks(6535));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 10, 22, 8, 24, 371, DateTimeKind.Local).AddTicks(6290));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 6, 10, 22, 8, 24, 373, DateTimeKind.Local).AddTicks(2737));
