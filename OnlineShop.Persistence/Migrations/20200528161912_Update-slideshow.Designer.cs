...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200528161912_Update-slideshow")]
    partial class Updateslideshow
    {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 28, 20, 49, 12, 487, DateTimeKind.Local).AddTicks(5988));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 20, 49, 12, 491, DateTimeKind.Local).AddTicks(6936));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 20, 49, 12, 500, DateTimeKind.Local).AddTicks(2417));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("3d7668de-176b-431c-b595-1b9d1962303f"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 30, 20, 49, 12, 519, DateTimeKind.Local).AddTicks(1161));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 20, 49, 12, 519, DateTimeKind.Local).AddTicks(898));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 28, 20, 49, 12, 520, DateTimeKind.Local).AddTicks(8328));
