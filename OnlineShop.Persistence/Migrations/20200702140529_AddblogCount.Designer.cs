...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200702140529_AddblogCount")]
    partial class AddblogCount
    {
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 7, 2, 18, 35, 29, 260, DateTimeKind.Local).AddTicks(2832));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 2, 18, 35, 29, 265, DateTimeKind.Local).AddTicks(5357));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 2, 18, 35, 29, 273, DateTimeKind.Local).AddTicks(1705));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagment.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("e0b12f36-7a85-48b5-9781-5ab43972748d"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 4, 18, 35, 29, 291, DateTimeKind.Local).AddTicks(2550));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 2, 18, 35, 29, 291, DateTimeKind.Local).AddTicks(2285));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserManagment.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 7, 2, 18, 35, 29, 292, DateTimeKind.Local).AddTicks(8493));
