...
namespace OnlineShop.Persistence.Migrations
{
    ...
    [Migration("20200529034411_Update-orderItems")]
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Blog", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTime(2020, 5, 29, 8, 14, 11, 148, DateTimeKind.Local).AddTicks(6946));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.ContactUs", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 8, 14, 11, 154, DateTimeKind.Local).AddTicks(6192));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.Menu", b =>
                {
                    ...
                    b.Property<DateTime>("CreationDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 8, 14, 11, 162, DateTimeKind.Local).AddTicks(1490));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.User", b =>
                {
                    ...
                    b.Property<Guid>("ActivationCode")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasDefaultValue(new Guid("06bda10d-25ff-472e-b9df-e0c8e543e34b"));
                    ...
                    b.Property<DateTime>("ExpiredVerification")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 31, 8, 14, 11, 179, DateTimeKind.Local).AddTicks(6784));
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 8, 14, 11, 179, DateTimeKind.Local).AddTicks(6518));
            ...
            modelBuilder.Entity("OnlineShop.Domain.Entities.UserFile", b =>
                {
                    ...
                    b.Property<DateTime>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2020, 5, 29, 8, 14, 11, 181, DateTimeKind.Local).AddTicks(2716));
