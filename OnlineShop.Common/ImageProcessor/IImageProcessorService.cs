...
namespace OnlineShop.Common.ImageProcessor
{
    public interface IImageProcessorService
    {
        ...
        Image Merge(IFormFile upload, string rootPath, string directory, MergPosition mergPosition, float xSpace, float ySpace);
        ...
        Image MergeAndWriteTextOnImage(IFormFile upload, string rootPath, string watermarkePhotoPath, string text, string fontFamily, float fontSize, Brush color, MergPosition mergPosition, float xSpace, float ySpace, float xTextAdjustment = 0, float yTextAdjustment = 0);
        Image MergeAndWriteTextOnImage(Image image, string rootPath, string watermarkePhotoPath, string text, string fontFamily, float fontSize, Brush color, MergPosition mergPosition, float xSpace, float ySpace, float xTextAdjustment, float yTextAdjustment);
